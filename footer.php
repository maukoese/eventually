		...
		<!-- Footer -->
			<footer id="footer">
				<ul class="icons">
					...
					<li><a href="<?php _show_( $social['facebook']); ?>" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
					<li><a href="<?php _show_( $social['twitter']); ?>" class="icon fa-twitter"><span class="label">Twitter</span></a></li>
					<li><a href="<?php _show_( $social['instagram']); ?>" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
					<li><a href="<?php _show_( $social['github']); ?>" class="icon fa-github"><span class="label">GitHub</span></a></li>
